# Your Health Diary — live open source product

A simple, local-first diary for remembering the details between doctor visits.
...
| Deploy in your Vercel account | [Deploy your copy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fharshithag841-gif%2Fhealth-diary-template) |
| Report a problem or suggest a change | [Issues](https://github.com/harshithag841-gif/health-diary-template/issues) |
...
After the first online setup, keep using the same production URL and browser. Keep private backups: browser storage can be cleared, and local records and backup files are not encrypted by this template. See the PRD and README for the full storage model and limits.

Small bug fixes, accessibility improvements and clearer documentation are welcome. Use only fictional data in issues and pull requests.
