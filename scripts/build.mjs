...
for(const name of ['index.html','styles.css','app.js','db.js','model.js','visits.js','visit-model.js','icon.svg','icons/icon-192.png','icons/icon-512.png','icons/maskable-512.png'])await readFile(new URL(name,source));
